export interface PricingRule {
    [itemName:string]: {
        itemPrice: number,
        discountCalculator: (quantity: number, price: number) => number
    }
}

export class UnidaysDiscountChallenge{
    ...
    CalculateTotalPrice(){
        ...
        if (total > 0 && total < 50) delivery = 7.00;
...
export const defaultPricingRule = {
    'A': {
        itemPrice: 8.00,
